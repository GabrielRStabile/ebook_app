...
class AppTheme extends ThemeExtension<AppTheme> {
  const AppTheme({
    this.primaryColor = const Color(0xFFDAAA63),
    this.tertiaryColor = const Color(0xFF2C1810),
    this.neutralColor = const Color(0xFFF0E9E0),
  });
  ...
  ThemeData _base(final ColorScheme colorScheme) {
    ...
    final secondaryTextTheme = GoogleFonts.rosarivoTextTheme();
